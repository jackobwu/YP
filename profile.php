...
<body>
    ...
    <div class="container">
        <h1><?php echo $username; ?>'s Profile <?php if ($verified) { echo '<i class="glyphicon glyphicon-ok-sign verified" data-toggle="tooltip" title="Verified User" style="font-size:28px;color:#da052b;"></i>'; } ?></h1><br >
    </div>
    <div class="container">
                ...
                <div class="col-md-3">
                    <ul class="list-group">
                        <li class="list-group-item"><span><strong>About Me</strong></span>
                            <p>Welcome to my profile this is just a demo, but soon we will push the complete one!&nbsp;</p>
                        </li>
                    </ul>
                </div>
                <div class="col-md-6">
