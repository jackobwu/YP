            ...
            <form>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <li role="presentation"><a href="/youpeng/sns/messages.html">Messages </a></li>
                        <li role="presentation"><a href="/youpeng/sns/messages.html">Notifications </a></li>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <ul class="nav navbar-nav hidden-md hidden-lg navbar-right">
                        ...
                        <li class="dropdown open"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li role="presentation"><a href="#">My Profile</a></li>
                                <li class="divider" role="presentation"></li>
                                <li role="presentation"><a href=/youpeng/sns/index.php>Timeline </a></li>
                                <li role="presentation"><a href=/youpeng/sns/messages.html>Messages </a></li>
                                <li role="presentation"><a href="/youpeng/sns/notify.php">Notifications </a></li>
                                <li role="presentation"><a href="#">My Account</a></li>
                                <li role="presentation"><a href="#">Logout </a></li>
                            </ul>
                        </li>
                    ...
                    <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li role="presentation"><a href=/youpeng/sns/profile.php?username=<?php echo $username; ?>>My Profile</a></li>
                                <li class="divider" role="presentation"></li>
                                <li role="presentation"><a href="#">Timeline </a></li>
                                <li role="presentation"><a href="/youpeng/sns/messages.html">Messages </a></li>
                                <li role="presentation"><a href="/youpeng/sns/notify.php">Notifications </a></li>
                                <li role="presentation"><a href="/youpeng/sns/profile.php?username=<?php echo $username; ?>">My Account</a></li>
                                <li role="presentation"><a href="/youpeng/sns/logout.php">Logout </a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        success: function(r) {
                                ...
                                $.each(posts, function(index) {
                                    if (posts[index].PostImage == "") {
                                        ...
                                        $('.timelineposts').html(
                                            $('.timelineposts').html() + '<blockquote><p>' + posts[index].PostBody + '</p><img src="" data-tempsrc="'+posts[index].PostImage+'" class="postimg" id="img'+posts[index].postId+'"><footer>Posted by ' + posts[index].PostedBy + ' on ' + posts[index].PostDate + '<button class="btn btn-default" data-id="' + posts[index].PostId + '" type="button" style="color:#eb3b60;background-image:url(&quot;none&quot;);background-color:transparent;"> <i class="glyphicon glyphicon-heart" data-aos="flip-right"></i><span> ' + posts[index].Likes + ' Likes</span></button><button class="btn btn-default comment" type="button" data-postid="' + posts[index].PostId + '" style="color:#eb3b60;background-image:url(&quot;none&quot;);background-color:transparent;"><i class="glyphicon glyphicon-flash" style="color:#f9d616;"></i><span style="color:#f9d616;"> Comments</span></button></footer></blockquote>'
                                        )
